...
?>
            ...
            <div class="col main-right container-fluid row">
                ...
                <div class="col-md-12 mt-2 mb-3 nav-page">
                    <h5 class="text-muted"><a href="">Kênh người bán</a> / <a href="">Quản lý sản phẩm</a> / <b
                            href="">Sửa thông tin sản phẩm</b></h5>
                </div>
                <!--  -->
                <div class="col-md-12 manage-products shadow">
                    <div class="col-md-12">
                        <i href="./edit-product.html" class="bi bi-pencil-square fs-2 text-primary"></i>
                        <span>
                            <strong class="fs-4 ms-2">Chỉnh sửa thông tin chi tiết sản phẩm</strong>
                        </span>
                    </div>
                    <!--  -->
                        ...
                        <div class="col-md-11">
                            ...
                            <form action="">
                                        ...
                                        <div class="col-md-12 pe-4">
                                            <div class="input-group mb-3">
                                                ...
                                                <textarea class="form-control" rows="10"
                                                    aria-label="With textarea" cols="40"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 pe-4">
                                            <div class="input-group mb-3">
                                ...
                                <div class="basic-info col-md-12 container-fluid px-0 pb-5 ms-0">
                                    ...
                                    <div class="row ms-5">
                                        <div class="card p-0 mb-3 me-3 d-flex justify-content-center"
                                            style="width: 200px;height: 200px;">
                                            <input type="file" name="" id="photo-1-input" onchange="loadPhoto1(event)">
                                            <label for="photo-1-input" type="button">
                                                <img id="photo-1-preview" src="../issets/img/no-image.png" alt=""
                                                    style="max-width: 100%;">
                                            </label>
                                            <!--  -->
                                            <div class="d-flex justify-content-between"
                                                style="position: absolute;margin-left: 140px; top: 0; border: solid 1px rgb(72, 120, 224); border-radius: 5px; background-color: rgba(188, 199, 219, 0.8);">
                                                <label for="photo-1-input" type="button">
                                                    <i class="bi bi-pencil-fill text-primary fs-5 ms-2"></i>
                                                </label>
                                                <i class="bi bi-trash-fill text-danger fs-5 ms-2" id="del-photo-1"
                                                    type="button"></i>
                                            </div>
                                            <!--  -->
                                        </div>
                                        ...
                                        <!-- Photo 2 -->
                                        <div class="card px-0 mb-3 me-3 d-flex justify-content-center align-items-center"
                                            style="width: 200px;height: 200px;background-size: contain;">
                                            <input type="file" name="" id="photo-2-input" onchange="loadPhoto2(event)">
                                            <label for="photo-2-input" type="button">
                                                <img id="photo-2-preview" src="../issets/img/no-image.png" alt=""
                                                    style="max-width: 100%;">
                                            </label>
                                        </div>
                                        <!--  -->
                                        ...
                                        <div class="card px-0 mb-3 me-3 d-flex justify-content-center align-items-center"
                                            ...
                                            <label for="photo-3-input" type="button">
                                                <img id="photo-3-preview" src="../issets/img/no-image.png" alt=""
                                                    style="max-width: 100%;">
                                            </label>
                                        </div>
                                        <!--  -->
                                ...
                                <div class="col-md-12 py-2 d-flex justify-content-end">
                                    ...
                                    <button class="btn btn-primary px-4 mx-3" type="submit">Cập nhật</button>
                                </div>
                            </form>
                        </div>
                    </div>
