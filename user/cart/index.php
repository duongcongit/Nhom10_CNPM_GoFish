    ...
    <div class="row">
        ...
        <div class="col-md-12 col-lg-9 mb-5">
            ...
            <div class="prod-cart-info col-md-12 bg-light px-3 py-2 mb-4">
                <div class="col-md-12"><input class=" btn-check-shop me-1 form-check-input" type="checkbox" style="cursor: pointer;"><i class="bi bi-shop m-1"></i>ABC Store</div>
                <!-- Product -->
                <div class="prod-info mb-0 mt-3 col-md-12 bg-light d-flex d-flex align-items-center px-3 py-2">
                    <div style="width: 40%;" class="mb-4 d-flex align-items-center">
                        ...
                        <img src="<?php echo SITEURL ?>assets/img/ca-canh-bien-hoang-gia-bien-do-regal-angelfish-red-sea.jpg" alt="" class="product-avatar-list" style="width: 70px;">
                        <span class="quick-produc-name ms-2">Cá cảnh biển hoàng gia</span>
                    </div>
                    <div class="mb-4" style="width: 20%;">426.000<u class="ms-1">đ</u></div>
                    <div style="width: 20%;">
                        <ul class="pagination">
                            <li class="page-item page-item-btn-decrease">
                                <a class="page-link bi bi-dash-lg" id="btn-decrease-cart" type="button"></a>
                            </li>
                            <li class="page-item">
                                <input type="text" id="input-quantity-cart" class="page-link px-2 text-dark" autocomplete="off" value="1" style="width: 40px;">
                            </li>
                            <li class="page-item">
                                <a class="page-link bi-plus-lg" id="btn-increase-cart" type="button"></a>
                            </li>
                        </ul>
                    </div>
                    <div style="width: 20%;" class="text-danger mb-4">852.000<u class="ms-1">đ</u></div>
                    <div class="mb-4"><i type="button" class="bi bi-trash text-muted fs-5 btn-remove-cart"></i></div>
                </div>
                <!-- Product -->
            </div>
            <!-- Shop -->
        ...
        <div class="col-md-12 col-lg-3">
            <div class="col-md-12 bg-light px-3">
                ...
                <div class="col-md-12">
                    ...
                    <p class="text-muted mt-1 pb-4">Đống Đa, Hà Nội</p>
                </div>
            </div>
