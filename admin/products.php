...
<div class="col-md-12 mt-2 mb-3 nav-page">
    <h5 class="text-muted"><a href="../account.php">Trang quản trị</a> / </span><a href="./products.php">Quản lý sản phẩm</a></h5>
</div>
    ...
    <div class="col-md-12 mt-3">
        ...
        <table class="styled-table">
            ...
            <tbody id="table-products">
                <!--  -->
                <?php
                $sql = "SELECT users.username,products.productName,products.productID,product_image.image,products.status,products.stock FROM products,users,product_image where products.userid = users.id  and products.productID = product_image.productID and product_image.image like '1%' ";
                                ...
                                <tr>
                                    <th class="row">
                                        <div style="max-width: fit-content;">
                                            <img src="../assets/img/products/<?php echo $row['image'] ?>" alt="" class="product-avatar-list">
                                        </div>
