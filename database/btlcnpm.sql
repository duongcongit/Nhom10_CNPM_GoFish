...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 09, 2022 lúc 03:47 AM
...
INSERT INTO `users` (`id`, `userID`, `fullname`, `username`, `email`, `telephone`, `address`, `password`, `status`, `email_verification_link`, `email_verified_at`) VALUES
(1, 'U001', 'xuân bình', 'xb2721', 'binhphan2721@gmail.com', '0974486946', 'HN', '$2y$10$RTg/l1ilFEAOdcKHETSiVedKx7yI64XNKPzjJFvsP3HOlAtVIwbPu', 1, 'f9127d2b51814398c924fa37eacb36c62863', '2022-03-05 09:48:28'),
(2, 'U002', 'công minh', 'minhlc', 'lecongminh@gmail.com', '0965469464', 'HN', '$2y$10$RTg/l1ilFEAOdcKHETSiVedKx7yI64XNKPzjJFvsP3HOlAtVIwbPu', 1, 'f9127d2b51814398c924fa37eacb36c62863', '2022-03-07 00:48:28');
...
--
ALTER TABLE `item`
  ADD CONSTRAINT `item_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `users` (`userID`);
COMMIT;
