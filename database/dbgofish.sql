...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 15, 2022 lúc 08:15 AM
...
(69, 'RLBL1', 'Tép rili đen hay còn gọi là rili carbon', 'Cá, tép, ốc cảnh', 'Rili đen hay còn gọi là rili carbon là dòng tép cảnh đẹp với đặc điểm nổi bật là các khoang màu đen phân cách bởi phần thân giữa trong suốt rất thu hút người chơi.', 15000, 900, 0, 1, '69-1.jpg', 2),
...
(80, 'DLEDOA', 'Đèn Led Chihiros chuyên dụng cho hồ thủy sinh dòng A Series', 'Phụ kiện hồ cá', 'Đèn Led Chihiros là mẫu đèn led cao cấp chuyên dụng cho hồ thủy sinh, Đèn Led Chihiros Dòng A Series phù hợp với hầu hết các loại cây thủy sinh.', 365000, 67, 0, 1, '80-1.jpg', 2),
...
(89, 'CASACGAM', 'CÁ SẶC GẤM', 'Cá, tép, ốc cảnh', 'Cá Sặc Gấm là một trong những loại cá cảnh độc đáo và đẹp mắt được nhiều dân chơi cá cảnh yêu thích và nuôi trong bể cảnh. Đặc biệt, cá sặc gấm còn được đánh giá là loại cá dễ nuôi, có thể thích hợp với những người mới chơi bể cảnh.', 105000, 618, 0, 1, '89-1.jpg', 1);
